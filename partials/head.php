...
<div class="pos-f-t">
    <div class="collapse" id="navbarToggleExternalContent">
        <div class="bg-danger p-4">
            ...
            <small class="text-white">Made by <a href="https://github.com/gtkacz/scandiweb-ps" target="_blank"
                                                 title="View source code">Gabriel Tkacz</a></small>
        </div>
    </div>
    <nav class="navbar navbar-dark bg-dark">
        <button style="visited: none; text-decoration: none; decoration: none;" class="navbar-toggler" type="button"
