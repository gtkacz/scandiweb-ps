...
<body>
    ...
    <form method="post" action="edit" autocomplete="off" id="product_form">
        ...
        <div class="card-edit">
            ...
            <input type="text" class="fake-input" placeholder="Edit price" pattern="[0-9]+" min="0" oninput="validity.valid||(value='');" id="price" name="Price" value=<?php echo $product->PRICE ?> oninvalid="this.setCustomValidity('Please, submit required data')" oninput="this.setCustomValidity('')" required><br>
